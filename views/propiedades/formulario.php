<fieldset>
    ...
    <label for="imagenes">Imagenes descriptivas (OPCIONAL):</label>
    <input type="file" id="imagenes" accept="image/jpeg, image/png" name="imagenes[]" multiple>

    <div class="actualizarImagenes seccion">
        <?php if(isset($imagenes) && !empty($imagenes)){?>
            <?php foreach($imagenes as $imagen){?>
                <img src="/imagenes/otras/<?php echo $imagen->url;?>" class="imagen-small" alt="">
            <?php }?>
        <?php } ?>
    </div>
